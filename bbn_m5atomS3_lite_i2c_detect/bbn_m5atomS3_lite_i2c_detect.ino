...
static I2cDeviceInfo I2C_SCANNER_KNOWN_DEVICES[] = {
  ...
  {"MPU-9250", "9-DoF IMU Gyroscope, Accelerometer and Magnetometer", (uint8_t[]){0x68, 0x69, 0x0}, (uint8_t)0x0, (uint8_t)0x48},
  {"MPU-9250", "3-Axis Gyroscope and Accelerometer", (uint8_t[]){0x68, 0x0}, (uint8_t)0x0, (uint8_t)0x48},
