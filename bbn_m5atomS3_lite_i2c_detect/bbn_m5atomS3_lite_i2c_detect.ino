...
static I2cDeviceInfo I2C_SCANNER_KNOWN_DEVICES[] = {
  ...
  {"ADXL345", "3-axis accelerometer", (uint8_t[]){0x53, 0x1d, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"BMA180", "Accelerometer", (uint8_t[]){0x77, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"BME280", "Temp/Barometric/Humidity", (uint8_t[]){0x77, 0x76, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"BME680", "Low power gas, pressure, temperature & humidity sensor", (uint8_t[]){0x77, 0x76, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"BMP180", "Temp/Barometric", (uint8_t[]){0x77, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"BMP280", "Temp/Barometric", (uint8_t[]){0x77, 0x76, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"BNO055", "Absolute Orientation Sensor", (uint8_t[]){0x28, 0x29, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"CAP1188", "8-channel Capacitive Touch", (uint8_t[]){0x2c, 0x2a, 0x2b, 0x2d, 0x28, 0x29, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"CCS811", "Volatile organics (VOC) and equivalent CO2 (eCO2) sensor", (uint8_t[]){0x5b, 0x5a, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"CCS811", "Ultra-Low Power Digital Gas Sensor for Monitoring Indoor Air Quality TVOC eCO2", (uint8_t[]){0x5b, 0x5a, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"DRV2605", "Haptic Motor Driver", (uint8_t[]){0x5a, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"DS1307", "64 x 8 Serial Real-Time Clock", (uint8_t[]){0x68, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"DS1371", "I2C, 32-Bit Binary Counter Watchdog Clock", (uint8_t[]){0x68, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"DS3502", "High-Voltage, NV, I2C POT", (uint8_t[]){0x2a, 0x2b, 0x28, 0x29, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"FXOS8700", "6-axis sensor with integrated linear accelerometer and magnetometer", (uint8_t[]){0x1c, 0x1d, 0x1f, 0x1e, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"HDC1008", "Low Power, High Accuracy Digital Humidity Sensor with Temperature Sensor", (uint8_t[]){0x43, 0x42, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"HMC5883", "3-Axis Digital Compass/Magnetometer IC", (uint8_t[]){0x1e, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"HT16K33", "LED Matrix Driver", (uint8_t[]){0x71, 0x72, 0x77, 0x73, 0x70, 0x76, 0x75, 0x74, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"HTS221", "Capacitive digital sensor for relative humidity and temperature", (uint8_t[]){0x5f, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"ICM-20948", "9-Axis Motion Tracking device", (uint8_t[]){0x68, 0x69, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"INA219", "26V Bi-Directional High-Side Current/Power/Voltage Monitor", (uint8_t[]){0x46, 0x49, 0x47, 0x48, 0x4c, 0x4d, 0x43, 0x4b, 0x44, 0x41, 0x4a, 0x45, 0x42, 0x4f, 0x4e, 0x40, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"INA260", "Precision Digital Current and Power Monitor With Low-Drift, Precision Integrated Shunt", (uint8_t[]){0x46, 0x49, 0x47, 0x48, 0x4c, 0x4d, 0x43, 0x4b, 0x44, 0x41, 0x4a, 0x45, 0x42, 0x4f, 0x4e, 0x40, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"IS31FL3731", "144-LED Audio Modulated Matrix LED Driver (CharliePlex)", (uint8_t[]){0x77, 0x66, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"ISL29125", "Digital Red, Green and Blue Color Light Sensor with IR Blocking Filter", (uint8_t[]){0x44, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"LIS3DH", "3-axis accelerometer", (uint8_t[]){0x18, 0x19, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"LPS22HB", "MEMS nano pressure sensor", (uint8_t[]){0x2e, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"LSM303", "Triple-axis Accelerometer+Magnetometer (Compass)", (uint8_t[]){0x19, 0x1e, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"LSM303", "Triple-axis Accelerometer+Magnetometer (Compass)", (uint8_t[]){0x18, 0x1e, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  ...
  {"MPU6050", "Six-Axis (Gyro + Accelerometer) MEMS MotionTracking™ Devices", (uint8_t[]){0x68, 0x69, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"MPU-9250", "9-DoF IMU Gyroscope, Accelerometer and Magnetometer", (uint8_t[]){0x68, 0x69, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
  {"MPU-9250", "3-Axis Gyroscope and Accelerometer", (uint8_t[]){0x68, 0x0}, (uint8_t)0x0, (uint8_t)0x0},
